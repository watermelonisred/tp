...
Shows a list of all persons in the NUSNETID book.

Format: `list`

### Editing a person : `edit`

Edits an existing person in the NUSNETID book.
...
Examples:
*  `edit 1 p/91234567 e/johndoe@example.com` Edits the phone number and email NUSNETID of the 1st person to be `91234567` and `johndoe@example.com` respectively.
...
Deletes the specified person from the NUSNETID book.
...
Examples:
* `list` followed by `delete 2` deletes the 2nd person in the NUSNETID book.
* `find Betsy` followed by `delete 1` deletes the 1st person in the results of the `find` command.

### Clearing all entries : `clear`

Clears all entries from the NUSNETID book.
